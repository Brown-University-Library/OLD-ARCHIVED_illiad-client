...
class ParserTest(unittest.TestCase):
    ...
    def test_article_request_key(self):
        ...
        def _key_check(key_list, rdict):
            for k in key_list:
                self.assertTrue(rdict.has_key(k),
        ...
        self.assertEqual(atitle, 
                         u'Targeting \xce\xb17 Nicotinic Acetylcholine Receptors in the Treatment of Schizophrenia.')
    ...
    def test_completed_request_submission(self):
        ...
        self.assertEqual(submit['transaction_number'],
                        '476993')
